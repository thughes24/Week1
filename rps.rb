...
def win_or_lose(choice1,choice2)
  if choice1 == choice2
    ...
    case choice1
      ...
      when "r" then puts choice2 == "s" ? "You went #{Choices[choice1]}, Computer went Scissors, you lose!" : "You went #{Choices[choice1]}, computer went Rock, you win!"
...
end until player_choice = Choices.keys.include?(player_choice)
